...
var is_same_address_1 = require("../../common/utils/is-same-address");
...
var UniswapRouterFactory = /** @class */ (function () {
                            ...
                            for (pairs = 0; pairs < findPairs.length; pairs++) {
                                for (tokenPairs = 0; tokenPairs < findPairs[pairs].length; tokenPairs++) {
                                    ...
                                    if (((_d = (_c = this._settings) === null || _c === void 0 ? void 0 : _c.customNetwork) === null || _d === void 0 ? void 0 : _d.nativeCurrency.symbol) === 'KAIA') {
                                        times = 4;
                                        feeArray = [fee_amount_v3_1.FeeAmount.LOW, fee_amount_v3_1.FeeAmount.ONE_THOUSAND, fee_amount_v3_1.FeeAmount.MEDIUM, fee_amount_v3_1.FeeAmount.HIGH];
                                    }
                                    ...
                                    if (((_f = (_e = this._settings) === null || _e === void 0 ? void 0 : _e.customNetwork) === null || _f === void 0 ? void 0 : _f.nativeCurrency.symbol) === 'MNT') {
                                        times = 3;
                                        feeArray = [fee_amount_v3_1.FeeAmount.ONE_HUNDRED, fee_amount_v3_1.FeeAmount.LOW, fee_amount_v3_1.FeeAmount.MEDIUM, fee_amount_v3_1.FeeAmount.HIGH];
                                    }
                    ...
                    case 1:
                        ...
                        if (this._settings.uniswapVersions.includes(uniswap_version_1.UniswapVersion.v3)) {
                            ...
                            fromTokenRoutes = {
                                token: this._fromToken,
                                pairs: {
                                    fromTokenPairs: this.getTokenAvailablePairsV3(this._fromToken, availablePairs, router_direction_1.RouterDirection.from),
                                },
                            };
                            toTokenRoutes = {
                                token: this._toToken,
                                pairs: {
                                    toTokenPairs: this.getTokenAvailablePairsV3(this._toToken, availablePairs, router_direction_1.RouterDirection.to),
                                },
                            };
                            allMainRoutes = [];
                            for (i = 0; i < this.allMainTokens.length; i++) {
                                fromTokenPairs = this.getTokenAvailablePairsV3(this.allMainTokens[i], availablePairs, router_direction_1.RouterDirection.from);
                                toTokenPairs = this.getTokenAvailablePairsV3(this.allMainTokens[i], availablePairs, router_direction_1.RouterDirection.to);
                                allMainRoutes.push({
                                    token: this.allMainTokens[i],
                                    pairs: { fromTokenPairs: fromTokenPairs, toTokenPairs: toTokenPairs },
                                });
                    ...
                    case 1:
                        ...
                        if (this._settings.uniswapVersions.includes(uniswap_version_1.UniswapVersion.v2)) {
                            contractCallContext.push({
                                ...
                                abi: get_uniswap_contracts_1.uniswapContracts.v2.getRouterAbi(this._settings.cloneUniswapContractDetails),
                                calls: [],
                                context: routes.v2,
                            });
                                ...
                                if (routeCombo.length == 2) {
                                    contractCallContext[this._settings.uniswapVersions.includes(uniswap_version_1.UniswapVersion.v2) ? 1 : 0].calls.push({
                                        ...
                                        methodParameters: [
                                            routeCombo[0],
                                            routeCombo[1],
                                            fee_amount_v3_1.percentToFeeAmount(routes.v3[i].liquidityProviderFeesV3[0]),
                                            tradeAmount,
                                            0,
                                        ],
                                    });
    ...
    UniswapRouterFactory.prototype.generateTradeDataEthToErc20Input = function (ethAmountIn, tokenAmount, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapExactETHForTokens(hexlify_1.hexlify(convertedMinTokens), routeQuoteTradeContext.routePathArray.map(function (r) {
    ...
    UniswapRouterFactory.prototype.generateTradeDataEthToErc20Output = function (ethAmountInMax, tokenAmountOut, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapETHForExactTokens(hexlify_1.hexlify(amountOut), routeQuoteTradeContext.routePathArray.map(function (r) {
                    return eth_1.removeEthFromContractAddress(r);
                }), this._ethereumAddress, deadline);
            case uniswap_version_1.UniswapVersion.v3:
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToEthInput = function (tokenAmount, ethAmountOutMin, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapExactTokensForETH(hexlify_1.hexlify(amountIn), hexlify_1.hexlify(parse_ether_1.parseEther(ethAmountOutMin)), routeQuoteTradeContext.routePathArray.map(function (r) {
                    return eth_1.removeEthFromContractAddress(r);
                }), this._ethereumAddress, deadline);
            case uniswap_version_1.UniswapVersion.v3:
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToEthOutput = function (tokenAmountInMax, ethAmountOut, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapTokensForExactETH(hexlify_1.hexlify(parse_ether_1.parseEther(ethAmountOut)), hexlify_1.hexlify(amountInMax), routeQuoteTradeContext.routePathArray.map(function (r) {
                    return eth_1.removeEthFromContractAddress(r);
                }), this._ethereumAddress, deadline);
            case uniswap_version_1.UniswapVersion.v3:
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToErc20Input = function (tokenAmount, tokenAmountMin, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapExactTokensForTokens(hexlify_1.hexlify(amountIn), hexlify_1.hexlify(amountMin), routeQuoteTradeContext.routePathArray, this._ethereumAddress, deadline);
            case uniswap_version_1.UniswapVersion.v3:
    ...
    UniswapRouterFactory.prototype.generateTradeDataErc20ToErc20Output = function (tokenAmountInMax, tokenAmountOut, routeQuoteTradeContext, deadline) {
        ...
        switch (routeQuoteTradeContext.uniswapVersion) {
            case uniswap_version_1.UniswapVersion.v2:
                return this._uniswapRouterContractFactoryV2.swapTokensForExactTokens(hexlify_1.hexlify(amountOut), hexlify_1.hexlify(amountInMax), routeQuoteTradeContext.routePathArray, this._ethereumAddress, deadline);
            case uniswap_version_1.UniswapVersion.v3:
     ...
     * @param deadline The deadline it expiries unix time
     */
    UniswapRouterFactory.prototype.generateTradeDataForV3Input = function (tokenAmount, tokenAmountMin, routeQuoteTradeContext, deadline) {
        var isNativeReceivingNativeEth = eth_1.isNativeEth(this._toToken.contractAddress);
        var isSingle = routeQuoteTradeContext.routePathArray.length == 2;
        var multicallData = [];
        if (isSingle) {
            var params = {
                tokenIn: eth_1.removeEthFromContractAddress(this._fromToken.contractAddress),
            ...
            var params = {
                path: this.getEncodedPoolsPath(routeQuoteTradeContext.routePathArray.map(function (r) {
                    return eth_1.removeEthFromContractAddress(r);
            ...
            multicallData.push(this._uniswapRouterContractFactoryV3.exactInput(params));
        }
        if (eth_1.isNativeEth(this._toToken.contractAddress)) {
            multicallData.push(this._uniswapRouterContractFactoryV3.unwrapWETH9(hexlify_1.hexlify(tokenAmountMin), this._ethereumAddress));
        }
     ...
     * @param deadline The deadline it expiries unix time
     */
    UniswapRouterFactory.prototype.generateTradeDataForV3Output = function (amountOut, amountInMaximum, routeQuoteTradeContext, deadline) {
        var isNativeReceivingNativeEth = eth_1.isNativeEth(this._toToken.contractAddress);
        var isSingle = routeQuoteTradeContext.routePathArray.length == 2;
        var multicallData = [];
        if (isSingle) {
            var params = {
                tokenIn: eth_1.removeEthFromContractAddress(this._fromToken.contractAddress),
                tokenOut: eth_1.removeEthFromContractAddress(this._toToken.contractAddress),
                fee: fee_amount_v3_1.percentToFeeAmount(routeQuoteTradeContext.liquidityProviderFee),
                recipient: isNativeReceivingNativeEth === true
                    ? '0x0000000000000000000000000000000000000000'
                    : this._ethereumAddress,
                deadline: deadline,
                amountOut: hexlify_1.hexlify(amountOut),
                amountInMaximum: hexlify_1.hexlify(amountInMaximum),
                sqrtPriceLimitX96: 0,
            };
            ...
            multicallData.push(this._uniswapRouterContractFactoryV3.exactOutput(params));
        }
        if (eth_1.isNativeEth(this._toToken.contractAddress)) {
            multicallData.push(this._uniswapRouterContractFactoryV3.unwrapWETH9(hexlify_1.hexlify(amountOut), this._ethereumAddress));
        }
        return this._uniswapRouterContractFactoryV3.multicall(multicallData);
    };
    /**
     ...
     * @param allMainRoutes All the main routes
     */
    UniswapRouterFactory.prototype.workOutAllPossibleRoutesV3 = function (fromTokenRoutes, toTokenRoutes, allMainRoutes) {
        var jointCompatibleRoutes = toTokenRoutes.pairs.toTokenPairs.filter(function (t) {
            return fromTokenRoutes.pairs.fromTokenPairs.find(function (f) {
                return is_same_address_1.isSameAddress(f.token.contractAddress, t.token.contractAddress);
            });
        });
        var routes = [];
            ...
            var _loop_6 = function (directRoute) {
                if (!routes.find(function (r) {
                    return r.route[0] === fromTokenRoutes.token &&
                        ...
                        r.liquidityProviderFeesV3[0] === fee_amount_v3_1.feeToPercent(directRoute.fee);
                })) {
                    routes.push({
                        route: [fromTokenRoutes.token, toTokenRoutes.token],
        ...
        var _loop_7 = function (i) {
            var tokenRoute = allMainRoutes[i];
            if (jointCompatibleRoutes.find(function (c) {
                return is_same_address_1.isSameAddress(c.token.contractAddress, tokenRoute.token.contractAddress);
            })) {
                var feeFrom2Main = fromTokenRoutes.pairs.fromTokenPairs.find(function (t) {
                    return is_same_address_1.isSameAddress(t.token.contractAddress, tokenRoute.token.contractAddress);
                }).fee;
                var feeMain2To = toTokenRoutes.pairs.toTokenPairs.find(function (t) {
                    return is_same_address_1.isSameAddress(t.token.contractAddress, tokenRoute.token.contractAddress);
                }).fee;
                routes.push({
                    route: [fromTokenRoutes.token, tokenRoute.token, toTokenRoutes.token],
                    liquidityProviderFee: 0,
                    liquidityProviderFeesV3: [
                        fee_amount_v3_1.feeToPercent(feeFrom2Main),
                        fee_amount_v3_1.feeToPercent(feeMain2To),
                    ],
                });
                    ...
                    if (tokenRoute.pairs.toTokenPairs.find(function (pair) {
                        ...
                        if (workedOutFromRoute.filter(only_unique_1.onlyUnique).length ===
                            ...
                            routes.push({
                                ...
                                liquidityProviderFee: 0,
                                liquidityProviderFeesV3: [
                                    fee_amount_v3_1.feeToPercent(feeFrom2Support),
                                    fee_amount_v3_1.feeToPercent(feeSupport2Main),
                                    fee_amount_v3_1.feeToPercent(feeMain2To),
                                ],
                            });
                        }
                ...
                var _loop_9 = function (f) {
                    ...
                    if (tokenRoute.pairs.fromTokenPairs.find(function (pair) {
                        ...
                        if (workedOutToRoute.filter(only_unique_1.onlyUnique).length ===
                            workedOutToRoute.length) {
                            var feeMain2Support = tokenRoute.pairs.fromTokenPairs.find(function (pair) {
                                return pair.token.contractAddress.toLowerCase() ===
                                    toSupportedToken.contractAddress.toLowerCase();
                            }).fee;
                            var feeSupport2To = toTokenRoutes.pairs.toTokenPairs[f].fee;
                            routes.push({
                                route: workedOutToRoute,
                                liquidityProviderFee: 0,
                                liquidityProviderFeesV3: [
                                    fee_amount_v3_1.feeToPercent(feeFrom2Main),
                                    fee_amount_v3_1.feeToPercent(feeMain2Support),
                                    fee_amount_v3_1.feeToPercent(feeSupport2To),
                                ],
                            });
                        }
                    }
    ...
    UniswapRouterFactory.prototype.getTokenAvailablePairsV3 = function (token, allAvailablePairs, direction) {
        switch (direction) {
            case router_direction_1.RouterDirection.from:
    ...
    UniswapRouterFactory.prototype.buildRouteQuoteForErc20ToErc20 = function (amountToTrade, callReturnContext, routeContext, direction, uniswapVersion) {
        ...
        var routePathArray = uniswapVersion === uniswap_version_1.UniswapVersion.v2
            ? callReturnContext.methodParameters[1]
            : routeContext.route.map(function (r) { return r.contractAddress; });
        ...
        switch (uniswapVersion) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return {
                    ...
                    routePathArrayTokenMap: routePathArray.map(function (c) {
    ...
    UniswapRouterFactory.prototype.buildRouteQuoteForEthToErc20 = function (amountToTrade, callReturnContext, routeContext, direction, uniswapVersion) {
        ...
        var expectedConvertQuote = direction === trade_direction_1.TradeDirection.input
            ? convertQuoteUnformatted
                .shiftedBy(this._toToken.decimals * -1)
                .toFixed(this._toToken.decimals)
            : new bignumber_js_1.default(format_ether_1.formatEther(convertQuoteUnformatted)).toFixed(this._fromToken.decimals);
        var expectedConvertQuoteOrTokenAmountInMaxWithSlippage = this.getExpectedConvertQuoteOrTokenAmountInMaxWithSlippage(expectedConvertQuote, direction, uniswapVersion);
        var tradeExpires = this.generateTradeDeadlineUnixTime();
        var routePathArray = uniswapVersion === uniswap_version_1.UniswapVersion.v2
            ? callReturnContext.methodParameters[1]
        ...
        switch (uniswapVersion) {
            ...
            case uniswap_version_1.UniswapVersion.v3:
                return {
                    ...
                    transaction: transaction,
                    tradeExpires: tradeExpires,
                    routePathArrayTokenMap: routePathArray.map(function (c, index) {
                        var _a, _b;
                        var token = deep_clone_1.deepClone(_this.allTokens.find(function (t) { return t.contractAddress === c; }));
                        if (index === 0) {
                            return eth_1.turnTokenIntoEthForResponse(token, (_b = (_a = _this._settings) === null || _a === void 0 ? void 0 : _a.customNetwork) === null || _b === void 0 ? void 0 : _b.nativeCurrency);
                        }
                        return token;
                    }),
                    routeText: routePathArray
    ...
    UniswapRouterFactory.prototype.buildRouteQuoteForErc20ToEth = function (amountToTrade, callReturnContext, routeContext, direction, uniswapVersion) {
        ...
        var convertQuoteUnformatted = this.getConvertQuoteUnformatted(callReturnContext, direction, uniswapVersion);
        var expectedConvertQuote = direction === trade_direction_1.TradeDirection.input
            ? new bignumber_js_1.default(format_ether_1.formatEther(convertQuoteUnformatted)).toFixed(this._toToken.decimals)
            : convertQuoteUnformatted
                .shiftedBy(this._fromToken.decimals * -1)
                .toFixed(this._fromToken.decimals);
        var expectedConvertQuoteOrTokenAmountInMaxWithSlippage = this.getExpectedConvertQuoteOrTokenAmountInMaxWithSlippage(expectedConvertQuote, direction, uniswapVersion);
    ...
    UniswapRouterFactory.prototype.formatAmountToTrade = function (amountToTrade, direction) {
        switch (this.tradePath()) {
            case trade_path_2.TradePath.ethToErc20:
                if (direction == trade_direction_1.TradeDirection.input) {
                    var amountToTradeWei = parse_ether_1.parseEther(amountToTrade);
                    return hexlify_1.hexlify(amountToTradeWei);
                }
                else {
                    return hexlify_1.hexlify(amountToTrade.shiftedBy(this._toToken.decimals));
                }
            case trade_path_2.TradePath.erc20ToEth:
                if (direction == trade_direction_1.TradeDirection.input) {
    ...
    UniswapRouterFactory.prototype.getEncodedPoolsPath = function (tokens, fees, direction) {
        ...
        var initialTokenAddress = convertedTokens[0];
    ...
    UniswapRouterFactory.prototype.tradePath = function () {
        ...
        return trade_path_1.getTradePath(network.chainId, this._fromToken, this._toToken, (_a = this._settings.customNetwork) === null || _a === void 0 ? void 0 : _a.nativeWrappedTokenInfo);
    };
    ...
    Object.defineProperty(UniswapRouterFactory.prototype, "mainCurrenciesPairsForFromToken", {
        get: function () {
            if (this._ethersProvider.provider.network.chainId === chain_id_1.ChainId.MAINNET ||
                ...
                if (!eth_1.isNativeEth(this._fromToken.contractAddress) &&
                    !eth_1.isNativeEth(this._toToken.contractAddress)) {
